...
void VertexArray::_glBegin (int type)
{
  n = 0;
  this->type = type;
}

void VertexArray::_glVertex3f (float x, float y, float z)
{
  if (n >= max) reallocData ();
  data [stride * n + 0] = x;
  data [stride * n + 1] = y;
  data [stride * n + 2] = z;
  n ++;
...
void VertexArray::_glVertex3fv (float *f)
{
  if (n >= max) reallocData ();
  data [stride * n + 0] = f [0];
  data [stride * n + 1] = f [1];
...
void VertexArray::_glNormal3f (float x, float y, float z)
{
  if (n >= max) reallocData ();
  data [stride * n + 3] = x;
  data [stride * n + 4] = y;
...
void VertexArray::_glColor4ub (int r, int g, int b, int a)
{
  if (n >= max) reallocData ();
...
void VertexArray::_glColor3ub (int r, int g, int b)
{
  glColor4ub (r, g, b, 255);
}

void VertexArray::_glColor4f (float r, float g, float b, float a)
{
  if (n >= max) reallocData ();
  data [stride * n + 6] = r;
  data [stride * n + 7] = g;
...
void VertexArray::_glColor3f (float r, float g, float b)
{
  glColor4f (r, g, b, 255);
}

void VertexArray::_glColor4fv (float *f)
{
  glColor4f (f [0], f [1], f [2], f [3]);
}

void VertexArray::_glColor3fv (float *f)
{
  glColor4f (f [0], f [1], f [2], 1);
}

void VertexArray::_glTexCoord2f (float x, float y)
{
  if (n >= max) reallocData ();
  data [stride * n + 10] = x;
  data [stride * n + 11] = y;
...
void VertexArray::_glTexCoord2fv (float *f)
{
  if (n >= max) reallocData ();
...
void VertexArray::_glTexCoord2d (float x, float y)
{
  if (n >= max) reallocData ();
  data [stride * n + 10] = x;
  data [stride * n + 11] = y;
